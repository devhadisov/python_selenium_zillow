...
def main(htmlstring, driver):
    ...
    first_url = "https://www.zillow.com/search/GetSearchPageState.htm?searchQueryState=%7B%22pagination%22%3A%7B%7D%2C%22usersSearchTerm%22%3A%2285138%22%2C%22mapBounds%22%3A%7B%22west%22%3A-112.20716283007813%2C%22east%22%3A-111.66608616992188%2C%22south%22%3A32.77485850048854%2C%22north%22%3A33.25504954983835%7D%2C%22regionSelection%22%3A%5B%7B%22regionId%22%3A417442%2C%22regionType%22%3A7%7D%5D%2C%22isMapVisible%22%3Atrue%2C%22mapZoom%22%3A11%2C%22filterState%22%3A%7B%22sort%22%3A%7B%22value%22%3A%22globalrelevanceex%22%7D%7D%2C%22isListVisible%22%3Atrue%7D&includeMap=false&includeList=true"

    default_url = "https://www.zillow.com/search/GetSearchPageState.htm?searchQueryState=%7B%22pagination%22%3A%7B%22currentPage%22%3A{}%7D%2C%22usersSearchTerm%22%3A%2285138%22%2C%22mapBounds%22%3A%7B%22west%22%3A-112.20716283007813%2C%22east%22%3A-111.66608616992188%2C%22south%22%3A32.77485850048854%2C%22north%22%3A33.25504954983835%7D%2C%22regionSelection%22%3A%5B%7B%22regionId%22%3A417442%2C%22regionType%22%3A7%7D%5D%2C%22isMapVisible%22%3Atrue%2C%22mapZoom%22%3A11%2C%22filterState%22%3A%7B%22sort%22%3A%7B%22value%22%3A%22globalrelevanceex%22%7D%7D%2C%22isListVisible%22%3Atrue%7D&includeMap=false&includeList=true"
    ...
    for page in range(1, 9):
        ...
        for i in range(0, len(properties_infos)):
            ...
            if "by owner" in status_text:
                ...
                with open("Zillow_Maricopan_AZ_85138_2ndway.csv", "a", newline="", encoding="utf-8") as f:
                    writer = csv.writer(f)
...
if __name__ == "__main__":
    ...
    open("Zillow_Maricopan_AZ_85138_2ndway.csv", "wb").close()
    header = ["Property Address", "Property Status", "Owner Phone Number"]

    with open("Zillow_Maricopan_AZ_85138_2ndway.csv", "a", newline="") as f:
