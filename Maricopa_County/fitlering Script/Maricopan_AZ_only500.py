...
def main(htmlstring, driver):
    ...
    for i in range(0, len(properties_infos)):
        ...
        if "by owner" in status_text:
            ...
            with open("Zillow_Maricopan_AZ_only500.csv", "a", newline="", encoding="utf-8") as f:
                writer = csv.writer(f)
...
if __name__ == "__main__":
    ...
    open("Zillow_Maricopan_AZ_only500.csv", "wb").close()
    header = ["Property Address", "Property Status", "Owner Phone Number"]

    with open("Zillow_Maricopan_AZ_only500.csv", "a", newline="") as f:
